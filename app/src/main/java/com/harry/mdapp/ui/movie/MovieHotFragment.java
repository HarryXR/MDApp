...
public class MovieHotFragment extends BaseListFragment<MovieResponse> implements MovieController.LoadListener,
    ...
    public static class MovieDelegate extends AdapterDelegate<MovieResponse> {
        ...
        public int getLayout() {
            return R.layout.list_item_movie2;
        }
