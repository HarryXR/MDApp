...
public class TitleBar extends LinearLayout{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (getId() == View.NO_ID) {
            setId(cn.ieclipse.af.R.id.titleBar);
        }
        ...
        addView(mLeftContainer, new LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(mMiddleContainer, new LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        addView(mRightContainer, new LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
